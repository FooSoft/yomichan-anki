...
class Ui_MainWindowReader(object):
    def setupUi(self, MainWindowReader):
        ...
        QtCore.QObject.connect(self.dockDefinitions, QtCore.SIGNAL(_fromUtf8("visibilityChanged(bool)")), self.actionToggleDefinitions.setChecked)
        QtCore.QObject.connect(self.dockAnki, QtCore.SIGNAL(_fromUtf8("visibilityChanged(bool)")), self.actionToggleAnki.setChecked)
